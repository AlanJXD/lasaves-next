...
export default function LoginPage() {
  ...
  return (
    <main className="relative px-5 pt-safe-top pb-safe-tabbar bg-transparent">
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-[420px] flex-col px-5 pt-[env(safe-area-inset-top,20px)] pb-[env(safe-area-inset-bottom,20px)]">
        ...
        <form className="space-y-5" onSubmit={handleSubmit} suppressHydrationWarning>
          ...
          <label className="block">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-[#e7e7ee] bg-white px-11 py-3 text-sm outline-none transition focus:border-[color:var(--brand)]"
          ...
          <label className="block">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-[#e7e7ee] bg-white px-11 py-3 pr-12 text-sm outline-none transition focus:border-[color:var(--brand)]"
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            >
              <div className={`h-5 w-10 rounded-full transition ${remember ? "bg-[color:var(--brand)]" : "bg-[#d2d7de]"}`}>
                <div
